...
export default function FaceEmotion() {
    ...
    return (
        <>
            ...
            <div className="min-h-screen text-slate-200 font-sans selection:bg-purple-500/30 overflow-x-hidden relative flex flex-col pt-24 pb-12"
                style={{ backgroundColor: '#07050e' }}>
                        ...
                        {!result ? (
                                            ...
                                            {!permission ? (
                                                <div className="flex flex-col items-center justify-center gap-4 relative z-20 w-full h-full">
                                                    ...
                                                    <button onClick={requestCamera}
                                                        ...
                                                        onMouseEnter={e => { e.currentTarget.style.boxShadow = '0 12px 35px rgba(168, 85, 247,0.4)'; e.currentTarget.style.transform = 'translateY(-2px)' }}
                                                        onMouseLeave={e => { e.currentTarget.style.boxShadow = '0 8px 25px rgba(168, 85, 247,0.3)'; e.currentTarget.style.transform = 'translateY(0)' }}
                                                    >
                                                        📷 Enable Camera
                                                    </button>
                                                            ...
                                                            const interval = setInterval(async () => {
                                                                ...
                                                                if (modelsLoaded && video.readyState === 4) {
                                                                    ...
                                                                    if (detections) {
                                                                        ...
                                                                        const emotionColor = EMOTION_COLORS[highestEmotion.charAt(0).toUpperCase() + highestEmotion.slice(1)] || '#d946ef'
                                                    ...
                                                    {videoBlob && !recording && (
                                                        <div className="absolute inset-0 bg-black/60 flex items-center justify-center rounded-xl">
                                                            <div className="text-center">
                                                                <p className="text-purple-400 font-bold text-xl">✅ Recording Complete!</p>
                                            ...
                                            {permission ? (
                                                <div className="p-6 md:p-8 text-center relative z-10 rounded-2xl border border-white/10 w-full" style={{ background: 'rgba(255,255,255,0.04)', boxShadow: '0 20px 40px rgba(0,0,0,0.2)' }}>
                                                    <h2 className="text-xl font-bold text-white mb-4 flex items-center justify-center gap-2">
                                                        <Brain className="text-purple-400" size={24} /> AI Analysis
                                                    </h2>
                                                    <p className="mb-6 text-[15px] font-medium text-slate-100 tracking-wide leading-relaxed" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", color: 'rgba(240,240,240,0.95)' }}>
                                                        {modelsLoaded
                                                            ? <><span className="text-purple-400 font-bold block mb-2 sm:inline sm:mb-0 text-lg sm:text-[15px]">💡 Instruction:</span> Look directly at the camera and speak naturally about your current feelings or thoughts for 20 seconds. Ensure your face is clearly visible.</>
                                                    ...
                                                    <div className="flex gap-3 justify-center flex-wrap">
                                                        {!recording && !videoBlob && (
                                                            <motion.button onClick={startRecording}
                                                                ...
                                                                style={{ background: 'linear-gradient(135deg, #a855f7, #7c3aed)', color: '#000000', fontWeight: 800, boxShadow: '0 8px 25px rgba(168, 85, 247,0.3)' }}
                                                                whileHover={modelsLoaded ? { scale: 1.02, boxShadow: '0 12px 35px rgba(168, 85, 247,0.4)' } : {}}
                                                            >
                                        ...
                                        <div className="lg:col-span-5 flex flex-col justify-between h-full w-full gap-4">
                                            ...
                                            {permission && (
                                                <motion.div className="glass-card p-5 mt-0 w-full" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                                                    <h3 className="text-sm font-bold text-fuchsia-400 mb-3 uppercase tracking-wider">Live Emotion Activity</h3>
                                            ...
                                            {permission && timelineData.length > 0 && (
                                                <motion.div className="glass-card p-5 mt-0 w-full" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                                                    <h3 className="text-sm font-bold text-fuchsia-400 mb-3 uppercase tracking-wider">Emotional State Timeline</h3>
                                            ...
                                            <motion.div className="glass-card p-5 mt-0 w-full" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
                                                <h3 className="text-sm font-bold text-fuchsia-400 mb-3 uppercase tracking-wider">Live Frame Count Summary</h3>
                                                <div className="grid grid-cols-4 gap-3 sm:grid-cols-7">
                                                    {Object.entries(liveCounts).map(([emp, count]) => (
                                                        <div key={emp} className="bg-slate-800/40 p-2 rounded-lg border border-slate-700/50 text-center flex flex-col justify-center items-center">
                                                            ...
                                                            <div className="text-fuchsia-300 font-mono text-lg font-bold mt-1 leading-none">{count}</div>
                            ...
                            <motion.div className="space-y-4"
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                    {[
                                        ['Emotion', result.facial_emotion, '#d946ef'],
                                ...
                                <motion.div className="bg-gradient-to-r from-purple-500/10 to-transparent border-l-4 border-purple-400 rounded-r-2xl p-6 my-6">
                                    <h3 className="text-[10px] uppercase tracking-[0.2em] text-slate-400 mb-2 flex items-center gap-2">
                                        <Brain size={14} className="text-purple-400" /> AI COUNSELLOR INSIGHT
                                    </h3>
                                    <p className="text-lg text-purple-50/90 font-medium leading-relaxed italic">
                                        "{
                                            {
                                ...
                                <motion.div className="bg-[#0d0a16]/80 backdrop-blur-xl border border-white/[0.04] rounded-[24px] p-6 shadow-2xl mt-4">
                                    <h3 className="text-[10px] uppercase tracking-[0.2em] text-slate-400 mb-4 flex items-center gap-2">
                                        <Activity size={14} className="text-fuchsia-400" /> ADVANCED PSYCHOLOGICAL METRICS
                                    </h3>
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <div className="bg-slate-800/40 p-4 rounded-lg border border-slate-700/50">
                                            <div className="text-[10px] uppercase tracking-[0.2em] text-slate-400 mb-1">Derived Complex Emotion</div>
                                            <div className="text-fuchsia-300 font-bold text-sm sm:text-base">{getComplexEmotion()}</div>
                                        </div>
                                        <div className="bg-slate-800/40 p-4 rounded-lg border border-slate-700/50">
                                            <div className="text-[10px] uppercase tracking-[0.2em] text-slate-400 mb-1">Emotional Volatility (Mood Swings)</div>
                                            <div className="text-fuchsia-300 font-bold text-sm sm:text-base">{calculateVolatility()}</div>
                                        </div>
                                    </div>
                                </motion.div>
                                ...
                                {/* Pie chart */}
                                {pieData.length > 0 && (
                                    <div className="bg-[#0d0a16]/80 backdrop-blur-xl border border-white/[0.04] rounded-[24px] p-6 shadow-2xl mt-4">
                                        ...
                                        <ResponsiveContainer width="100%" height={220}>
                                            <PieChart>
                                                ...
                                                <Tooltip formatter={v => `${v}%`}
                                                    contentStyle={{ background: 'rgba(15,23,42,0.9)', border: '1px solid rgba(217, 70, 239,0.3)', borderRadius: '8px' }} />
                                            </PieChart>
                                        </ResponsiveContainer>
                                    </div>
                                )}
                                    ...
                                    <div className="flex flex-wrap justify-center gap-3">
                                        {Object.entries(liveCounts).map(([emp, count]) => (
                                            <div key={emp} className="bg-black/40 border border-white/5 rounded-xl py-3 px-4 flex flex-col items-center min-w-[80px]">
                                                <div className="text-xl leading-none mb-1">{EMOTION_EMOJI[emp]}</div>
                                                <div className="text-purple-400 text-xl font-bold leading-none my-1">{count}</div>
                                ...
                                <div className="flex gap-4 mt-8 flex-col md:flex-row">
                                    ...
                                    <motion.button onClick={() => nav('/voice')}
                                        className="px-8 py-4 rounded-xl flex items-center justify-center gap-2 transition-all flex-1 bg-gradient-to-br from-[#a855f7] to-[#7c3aed] text-black font-bold uppercase tracking-widest shadow-[0_0_20px_rgba(168, 85, 247,0.3)] hover:shadow-[0_0_30px_rgba(168, 85, 247,0.5)]"
