...
export default function VoiceAnalysis() {
    ...
    // Inline preloader â€” same 1.5s pattern as Face Emotion page
    ...
    const bars = result ? [{ name: 'Confidence', value: parseFloat((result.confidence * 100).toFixed(1)), fill: '#fb7185' }] : []

    return (
        <>
            {/* â”€â”€ 1.5s Inline Preloader â”€â”€ */}
            <AnimatePresence>
                {isLoading && (
                    <motion.div
                        initial={{ opacity: 1 }}
            ...
            {/* â”€â”€ Root Wrapper with Hero Background â”€â”€ */}
            <div
                className="min-h-screen text-slate-200 font-sans selection:bg-sky-500/30 overflow-x-hidden relative flex flex-col pt-24 pb-12"
                style={{ minHeight: '100vh', fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif", background: '#071014' }}
            >
                ...
                {/* Page content â€” delayed entrance to play after preloader */}
                <motion.div
                ...
                >
                    ...
                    <div className="flex flex-col gap-6 w-full">
                        ...
                        >
                            ...
                            Back to Step 3 â€“ Facial Analysis
                        </button>
                    ...
                    <div className="text-center space-y-3 w-full">
                        ...
                        <p className="text-lg font-medium opacity-80" style={{ color: 'rgba(148,163,184,0.72)' }}>
                            Step 4/4 â€” 15-second voice recording for stress detection
                        </p>
                        <div className="h-px w-24 mx-auto mt-4" style={{ background: 'rgba(255,255,255,0.05)' }} />
                    </div>

                    {/* â”€â”€ Signature Glass Card â”€â”€ */}
                    <div
                                ...
                                >
                                    {activeTab === 'live' && (
                                        <>
                                            ...
                                            <div className="flex justify-center mb-6">
                                                <div className="relative">
                                                    <motion.div
                                                        ...
                                                        style={{
                                                            background: recording ? 'rgba(239,68,68,0.15)' : 'rgba(125,211,252,0.08)',
                                                            border: recording ? '1px solid rgba(239,68,68,0.4)' : '1px solid rgba(125,211,252,0.2)',
                                                        }}
                                                        animate={recording ? {
                                                            scale: [1, 1.12, 1],
                                                            boxShadow: [
                                                    ...
                                                    >
                                                        <Mic
                                                            size={44}
                                                            style={{ color: recording ? '#f87171' : '#7dd3fc' }}
                                                        />
                                                    </motion.div>
                                                    {recording && (
                                            ...
                                            <div className="flex justify-center gap-1 mb-6 h-16 items-end">
                                                {audioData.map((heightVal, i) => (
                                                    <motion.div
                                                        ...
                                                        style={{ background: recording ? '#7dd3fc' : 'rgba(255,255,255,0.12)' }}
                                            ...
                                            {!recording && audioBlob && (
                                                <div className="text-sky-400 font-bold mb-4 flex items-center justify-center gap-2">
                                                    <span className="text-xl">âœ…</span> Recording saved! Ready to analyze.
                                                </div>
                                            )}
                                            ...
                                            >
                                                {recording
                                                    ? 'ðŸŽ™ï¸ Keep speaking clearly. AI is mapping your acoustic energy...'
                                                    : audioBlob
                                                        ? 'Click Analyze to detect voice stress patterns'
                                                        : <>
                                                            <span className="text-sky-400 font-bold">ðŸ’¡ Instruction:</span>{' '}
                                            ...
                                            <div className="flex gap-3 justify-center flex-wrap">
                                                {!recording && !audioBlob && (
                                                    <motion.button
                                                        ...
                                                        whileHover={{ scale: 1.05, boxShadow: '0 12px 35px rgba(125,211,252,0.4)' }}
                                                    >
                            ...
                            >
                                ...
                                <div className="glass-card p-6">
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-5">
                                        {[
                                            ['Emotion', result.voice_emotion, '#fb7185'],
                                ...
                                >
                                    ðŸŽ¯ Stress Level: {result.voice_stress}
                                </div>
