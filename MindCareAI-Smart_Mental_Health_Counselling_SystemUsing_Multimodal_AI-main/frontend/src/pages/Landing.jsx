...
/* â”€â”€â”€ Feature data â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
const features = [
    {
...
/* â”€â”€â”€ Character-split animated heading â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
/* â”€â”€â”€ 3D tilt card â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
/* â”€â”€â”€ Floating orb decorations â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
function FloatingOrb({ size, x, y, opacity, delay, color = '#7dd3fc' }) {
    return (
        <motion.div
...
/* â”€â”€â”€ Kinetic Brand Title â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
/* Active Theoryâ€“style: per-char 3D entry + live cursor-reactive tilt + chromatic aberration */
const BRAND_CHARS = 'MINDBRIDGE\u00a0AI'.split('')
...
function KineticBrandTitle({ mouseX, mouseY }) {
    ...
    return (
        <div style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
            ...
            >
                <Brain size={28} style={{ color: '#7dd3fc' }} />
            </motion.div>

            {/* Kinetic wordmark â€” cursor-tilted container, per-char anims */}
            <motion.div
                style={{
                    perspective: 900,
                    rotateX: tiltX,
                ...
                {BRAND_CHARS.map((char, i) => (
                    <motion.span
                        ...
                        style={{
                            ...
                            background: i < 10
                                ? 'linear-gradient(170deg, #ffffff 10%, #e0f2fe 55%, #bae6fd 100%)'
                                : 'linear-gradient(170deg, #e0f2fe 0%, #38bdf8 50%, #0284c7 100%)',
                            WebkitBackgroundClip: 'text',
                            WebkitTextFillColor: 'transparent',
                            backgroundClip: 'text',
                            // Chromatic aberration: full on hovered char, partial on neighbours
                            textShadow: hovered === i
                                ? '-2px 0 2px rgba(255,0,80,0.5), 2px 0 2px rgba(0,200,255,0.5), 0 0 18px rgba(125,211,252,0.4)'
...
/* â”€â”€â”€ Hero Geometric Particles â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
/* Pure CSS + Framer Motion â€” glowing rings, squares, lines drifting for depth */
            ...
            {HERO_PARTICLES.map((p, i) => (
                <motion.div
                    ...
                    style={{
                        ...
                        border: p.type !== 'line' ? '1px solid rgba(125,211,252,0.6)' : 'none',
                        ...
                        boxShadow: p.type === 'ring'
                            ? `0 0 ${Math.round(p.w * 0.15)}px rgba(125,211,252,0.25)`
                            : p.type === 'square'
...
/* â”€â”€â”€ Horizontal scroll counter â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
export default function Landing() {
    ...
    // â”€â”€ GSAP ScrollTrigger init (runs after DOM mounts) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    useEffect(() => {
    ...
    const navLinks = [
        { label: 'Signals', id: 'features' },
        { label: 'Journey', id: 'how-it-works' },
        { label: 'Why Signals', id: 'problem' },
        { label: 'Care Layer', id: 'solution' },
        { label: 'Tech Stack', id: 'technology' },
        { label: 'Trust', id: 'security' },
        { label: 'Start', id: 'about' }
    ];
    ...
    return (
        ...
        >
            {/* â”€â”€ Google font import â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
            <style>{`
        ...
        @keyframes navBorderGlow {
          0%,100% { border-bottom-color: rgba(125,211,252,0.08); }
          50%      { border-bottom-color: rgba(125,211,252,0.22); }
        }
      ...
      `}</style>
                    ...
                    <div className="w-full max-w-[1600px] mx-auto flex items-center justify-between px-6 md:px-16 h-16">
                        ...
                        <div className="flex items-center gap-3 cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
                            ...
                            <span style={{ fontSize: 14, fontWeight: 700, letterSpacing: '0.05em', color: '#f0f0f0' }}>
                                Mind<span style={{ color: '#7dd3fc' }}>Bridge</span> AI
                            </span>
                        </div>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <motion.button
                                whileHover={{ scale: 1.03, boxShadow: '0 0 28px rgba(125,211,252,0.45)' }}
                                whileTap={{ scale: 0.97 }}
            ...
            `,
                ...
                {/* Hero content */}
                <motion.div
                    className="hero-text-layer relative z-10 flex flex-col justify-center items-center text-center"
                ...
                >
                    <div className="max-w-6xl mx-auto px-6 md:px-10 pt-20 pb-10">
                        ...
                        >
                            {/* â”€â”€ Kinetic brand title â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
                            ...
                            <motion.div variants={fadeUp} className="flex items-center justify-center gap-3">
                                <div style={{ width: 6, height: 6, borderRadius: '50%', background: '#7dd3fc', boxShadow: '0 0 10px rgba(125,211,252,0.8)' }} />
                                <GlitchText
                                    mode="auto"
                                    intensity={0.8}
                                    className="font-overline"
                                    style={{ fontSize: 10, letterSpacing: '0.26em', textTransform: 'uppercase', color: '#7dd3fc' }}
                                >
                                    Private Multimodal Wellness
                                </GlitchText>
                            </motion.div>

                            {/* Main headline â€” character split */}
                            <motion.div
                                variants={stagger}
                                initial="hidden"
                                animate="show"
                            ...
                            >
                                MindBridge AI blends{' '}
                                <span style={{ color: 'rgba(224,242,254,0.88)', fontWeight: 500 }}>behavior</span>,{' '}
                                <span style={{ color: 'rgba(224,242,254,0.88)', fontWeight: 500 }}>expression</span>, and{' '}
                                <span style={{ color: 'rgba(224,242,254,0.88)', fontWeight: 500 }}>voice cues</span>{' '}
                                into one calmer view of how you are doing, with privacy-first guidance at every step.
                            </motion.p>

                            {/* CTAs */}
                            <motion.div variants={fadeUp} custom={5} className="flex items-center justify-center gap-4 flex-wrap">
                                <motion.button
                                    whileHover={{ scale: 1.03, boxShadow: '0 0 40px rgba(125,211,252,0.45), 0 8px 32px rgba(0,0,0,0.3)' }}
                                    whileTap={{ scale: 0.97 }}
                                    onClick={() => nav('/register')}
                            ...
                            >
                                {[
                                    { value: 4, suffix: '', label: 'Signal Engines' },
                                    { value: 100, suffix: '%', label: 'Privacy-first' },
                                    { value: 2, suffix: 'min', label: 'Guided Flow' },
                                ].map(({ value, suffix, label }, i) => (
                                    <motion.div key={label} variants={fadeUp} custom={i} className="flex flex-col gap-1">
                                        <span style={{ fontSize: 'clamp(22px, 3vw, 32px)', fontWeight: 800, color: '#7dd3fc', letterSpacing: '-0.02em', lineHeight: 1 }}>
                                ...
                                <span style={{ fontSize: 11, color: 'rgba(255,255,255,0.25)', letterSpacing: '0.1em', textTransform: 'uppercase' }}
                                    ...
                                    Built for calm, private insight
                                </span>
                            </motion.div>
                        </motion.div>
                    </div>
            ...
            <section
                ...
                style={{ background: 'linear-gradient(180deg, #0b1114 0%, #071014 100%)', padding: 'clamp(60px, 10vw, 140px) clamp(20px, 5vw, 60px)', position: 'relative', zIndex: 10 }}
            >
                {/* Subtle grid lines */}
                <div
                    className="absolute inset-0 pointer-events-none"
            ...
            `,
                ...
                <div className="max-w-7xl mx-auto flex flex-col gap-16 relative z-10">
                    ...
                    >
                        <span className="font-overline" style={{ fontSize: 10, letterSpacing: '0.26em', textTransform: 'uppercase', color: '#7dd3fc' }}>
                            Signal Toolkit
                        </span>
                        <h2 className="scroll-reveal-heading font-display" style={{ fontSize: 'clamp(32px, 5vw, 64px)', fontWeight: 700, letterSpacing: '-0.02em', color: '#f0f0f0', lineHeight: 1.05, maxWidth: 640 }}>
                            Insight across every signal
                        </h2>
                        <p className="at-body" style={{ fontSize: 15, color: 'rgba(203,213,225,0.55)', maxWidth: 480, lineHeight: 1.8, fontWeight: 300 }}>
                            Four focused inputs and two safety layers work together to create a clearer wellbeing snapshot.
                        </p>
                    </motion.div>
            ...
            <section
                ...
                style={{ background: '#071014', padding: 'clamp(60px, 10vw, 140px) clamp(20px, 5vw, 60px)', position: 'relative', zIndex: 10 }}
            >
                {/* Green ambient bloom */}
                <div
                ...
                <div className="max-w-7xl mx-auto relative z-10 flex flex-col gap-16">
                    ...
                    >
                        ...
                        <p className="at-body" style={{ fontSize: 15, color: 'rgba(203,213,225,0.55)', maxWidth: 420, lineHeight: 1.8, fontWeight: 300 }}>
                            A short, structured path from account setup to a private support summary.
                        </p>
                    </motion.div>

                    {/* Steps â€” two column grid */}
                    <motion.div
                        variants={stagger} initial="hidden" whileInView="show"
                    ...
                    >
                        {steps.map((step, i) => (
                            ...
                            >
                                ...
                                >
                                    <span style={{ fontSize: 11, fontWeight: 800, color: '#7dd3fc', letterSpacing: '0.05em' }}>
                                        {step.n}
                                    </span>
                                </div>
                                ...
                                <div className="flex flex-col gap-1.5">
                                    <div className="flex items-center gap-2">
                                        <step.icon size={13} style={{ color: '#7dd3fc', opacity: 0.7 }} />
            ...
            {/* â”â” MULTIMODAL ADVANTAGE â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â” */}
            <section
                id="problem"
                className="relative w-full"
                style={{ background: 'linear-gradient(180deg, #071014 0%, #051209 100%)', padding: 'clamp(80px, 12vw, 160px) clamp(20px, 5vw, 60px)', position: 'relative', zIndex: 10 }}
            >
                <div className="absolute inset-0 pointer-events-none" style={{ backgroundImage: 'linear-gradient(rgba(125,211,252,0.022) 1px, transparent 1px), linear-gradient(90deg, rgba(125,211,252,0.022) 1px, transparent 1px)', backgroundSize: '100px 100px' }} aria-hidden="true" />

                <div className="max-w-7xl mx-auto flex flex-col gap-24 relative z-10">

                    {/* Row 1 â€” text left, image right */}
                    <motion.div
                    ...
                    >
                        <div className="flex flex-col gap-6">
                            <span className="font-overline" style={{ color: '#7dd3fc', fontSize: 10, letterSpacing: '0.26em' }}>Why Signals Matter</span>
                            <h2 className="font-display" style={{ fontSize: 'clamp(28px, 4vw, 52px)', fontWeight: 700, letterSpacing: '-0.02em', color: '#f0f0f0', lineHeight: 1.1 }}>
                                Wellbeing is clearer when{' '}
                                <span className="at-gradient-text">signals agree</span>{' '}
                                with the story.
                            </h2>
                            <p className="at-body" style={{ fontSize: 15, color: 'rgba(203,213,225,0.58)', lineHeight: 1.85, maxWidth: 480 }}>
                                Words can describe what happened, but they rarely carry the whole picture.
                                Stronger support comes from reading{' '}
                                <strong style={{ color: 'rgba(224,242,254,0.9)', fontWeight: 600 }}>facial micro-expressions</strong>,{' '}
                                <strong style={{ color: 'rgba(224,242,254,0.9)', fontWeight: 600 }}>vocal tremors</strong>, and{' '}
                                <strong style={{ color: 'rgba(224,242,254,0.9)', fontWeight: 600 }}>behavioural patterns</strong> together.
                            </p>
                            <div className="flex flex-col gap-3 mt-2">
                                {[
                                    ...
                                    >
                                        <div style={{ width: 36, height: 36, borderRadius: 8, background: 'rgba(125,211,252,0.08)', border: '1px solid rgba(125,211,252,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                                        ...
                                        <div className="flex flex-col gap-0.5 flex-1">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span style={{ display: 'flex', alignItems: 'center', gap: 5, padding: '2px 8px', borderRadius: 20, background: 'rgba(125,211,252,0.08)', border: '1px solid rgba(125,211,252,0.22)' }}>
                                                    <motion.span
                                                        animate={{ opacity: [1, 0.3, 1], scale: [1, 1.3, 1] }}
                                                        transition={{ duration: 1.8, repeat: Infinity, ease: 'easeInOut' }}
                                                        style={{ width: 5, height: 5, borderRadius: '50%', background: '#7dd3fc', display: 'inline-block', flexShrink: 0 }}
                                                    />
                                                    <span style={{ fontSize: 9, color: '#7dd3fc', fontFamily: "'Space Mono',monospace", letterSpacing: '0.12em', textTransform: 'uppercase', lineHeight: 1 }}>{badge}</span>
                                                </span>
                                            </div>
                        ...
                        {/* Image 1 â€” floating 3D glass frame, natural colors */}
                        <div style={{ perspective: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                            <motion.div
                                ...
                                style={{
                                    ...
                                    boxShadow: '0 0 0 1px rgba(125,211,252,0.08), 0 0 40px rgba(14,165,233,0.15), 0 40px 80px rgba(0,0,0,0.5)',
                                    position: 'relative',
                                    aspectRatio: '4/3',
                                    width: '100%',
                                    transformStyle: 'preserve-3d',
                            ...
                            >
                                ...
                                />
                                {/* Subtle dark vignette only â€” no color tint */}
                                ...
                                <div style={{ position: 'absolute', bottom: 18, left: 18, display: 'flex', alignItems: 'center', gap: 7, padding: '7px 13px', borderRadius: 8, background: 'rgba(0,0,0,0.55)', backdropFilter: 'blur(14px)', border: '1px solid rgba(255,255,255,0.10)' }}>
                                    <motion.span animate={{ opacity: [1, 0.3, 1] }} transition={{ duration: 1.8, repeat: Infinity }} style={{ width: 6, height: 6, borderRadius: '50%', background: '#7dd3fc', flexShrink: 0 }} />
                    ...
                    {/* Row 2 â€” image left, text right */}
                    <motion.div
                        initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-80px' }}
                        transition={{ duration: 0.8, delay: 0.1, ease: [0.22, 1, 0.36, 1] }}
                        className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center"
                    >
                        {/* Image 2 â€” floating 3D glass frame, natural colors, offset phase */}
                        <div style={{ perspective: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center' }} className="lg:order-first order-last">
                            ...
                            >
                                ...
                                <div style={{ position: 'absolute', top: 18, right: 18, display: 'flex', alignItems: 'center', gap: 7, padding: '7px 13px', borderRadius: 8, background: 'rgba(0,0,0,0.55)', backdropFilter: 'blur(14px)', border: '1px solid rgba(255,255,255,0.10)' }}>
                                    <motion.span animate={{ opacity: [1, 0.3, 1] }} transition={{ duration: 2.2, repeat: Infinity, delay: 0.5 }} style={{ width: 6, height: 6, borderRadius: '50%', background: '#7dd3fc', flexShrink: 0 }} />
                        ...
                        <div id="solution" className="flex flex-col gap-6">
                            <span className="font-overline" style={{ color: '#7dd3fc', fontSize: 10, letterSpacing: '0.26em' }}>The Solution</span>
                            <h2 className="font-display" style={{ fontSize: 'clamp(28px, 4vw, 52px)', fontWeight: 700, letterSpacing: '-0.02em', color: '#f0f0f0', lineHeight: 1.1 }}>
                                One platform.{' '}
                            ...
                            <p className="at-body" style={{ fontSize: 15, color: 'rgba(203,213,225,0.58)', lineHeight: 1.85, maxWidth: 480 }}>
                                MindBridge AI fuses all four modalities into a single severity score â€” giving you the accuracy of a clinical multi-session assessment in under two minutes.
                            </p>
                            <div className="flex flex-col gap-2 mt-2">
                                {[
                                    ...
                                    <div key={item} className="flex items-start gap-3">
                                        <CheckCircle2 size={15} style={{ color: '#7dd3fc', marginTop: 2, flexShrink: 0 }} />
            ...
            {/* â”â” TECHNOLOGY BENTO GRID â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â” */}
            <section
                id="technology"
                className="relative w-full"
                style={{ background: '#071014', padding: 'clamp(80px, 12vw, 160px) clamp(20px, 5vw, 60px)', position: 'relative', zIndex: 10 }}
            >
                <div className="max-w-7xl mx-auto flex flex-col gap-14 relative z-10">
                    <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true, margin: '-80px' }} className="flex flex-col gap-4">
                        <span className="font-overline" style={{ color: '#7dd3fc', fontSize: 10, letterSpacing: '0.26em' }}>Under the Hood</span>
                            ...
                            >
                                {card.img && (
                                    <div style={{ position: 'absolute', inset: 0, zIndex: 0, opacity: 0.12 }}>
                                        ...
                                        <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(180deg, transparent 0%, #071014 80%)' }} />
                                    </div>
                                )}
            ...
            {/* â”â” PRIVACY & SECURITY â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â” */}
            <section
                id="security"
                className="relative w-full"
                style={{ background: 'linear-gradient(180deg, #071014 0%, #060d12 100%)', padding: 'clamp(80px, 12vw, 160px) clamp(20px, 5vw, 60px)', position: 'relative', zIndex: 10 }}
            >
                <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(ellipse 60% 40% at 50% 50%, rgba(125,211,252,0.055) 0%, transparent 70%)' }} aria-hidden="true" />
                <div className="max-w-4xl mx-auto flex flex-col items-center text-center gap-14 relative z-10">
                    <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="flex flex-col items-center gap-5">
                        <span className="font-overline" style={{ color: '#7dd3fc', fontSize: 10, letterSpacing: '0.26em' }}>Trust &amp; Compliance</span>
                        ...
                        <p className="at-body" style={{ fontSize: 15, color: 'rgba(203,213,225,0.55)', lineHeight: 1.85, maxWidth: 480 }}>
                            Mental health is deeply personal. MindBridge AI is engineered from the ground up to keep your sessions private, your data secure, and your identity protected.
                        </p>
                    </motion.div>
                    ...
                    <motion.div variants={stagger} initial="hidden" whileInView="show" viewport={{ once: true, margin: '-50px' }} className="grid grid-cols-1 sm:grid-cols-3 gap-5 w-full">
                        {[
                            ...
                            <motion.div
                                ...
                                style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(125,211,252,0.12)', backdropFilter: 'blur(12px)', transition: 'box-shadow 0.4s ease, border-color 0.4s ease' }}
                                whileHover={{ boxShadow: '0 0 45px rgba(125,211,252,0.18)', borderColor: 'rgba(125,211,252,0.28)', transition: { duration: 0.3 } }}
                            >
                                <motion.div
                                    animate={{ boxShadow: ['0 0 18px rgba(125,211,252,0.2)', '0 0 38px rgba(125,211,252,0.48)', '0 0 18px rgba(125,211,252,0.2)'] }}
                                    transition={{ duration: 3.5, repeat: Infinity, ease: 'easeInOut' }}
                                    style={{ width: 64, height: 64, borderRadius: 18, background: 'linear-gradient(135deg, rgba(125,211,252,0.15), rgba(56,189,248,0.06))', border: '1px solid rgba(125,211,252,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
                                >
                                    <Icon size={26} style={{ color: '#7dd3fc' }} />
                                </motion.div>
            ...
            {/* â”â” CINEMATIC CTA â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â” */}
            <section
                id="about"
                className="cta-section relative w-full overflow-hidden"
                style={{ background: '#060d12', padding: 'clamp(100px, 14vw, 200px) clamp(20px, 5vw, 60px)', position: 'relative', zIndex: 10 }}
            >
                <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(ellipse 80% 60% at 50% 50%, rgba(125,211,252,0.09) 0%, rgba(125,211,252,0.03) 35%, transparent 70%)' }} aria-hidden="true" />
                <div className="absolute inset-0 pointer-events-none" style={{ backgroundImage: 'linear-gradient(rgba(125,211,252,0.025) 1px, transparent 1px), linear-gradient(90deg, rgba(125,211,252,0.025) 1px, transparent 1px)', backgroundSize: '60px 60px' }} aria-hidden="true" />
                ...
                >
                    <motion.div
                        animate={{ scale: [1, 1.1, 1], boxShadow: ['0 0 40px rgba(125,211,252,0.3)', '0 0 90px rgba(125,211,252,0.6)', '0 0 40px rgba(125,211,252,0.3)'] }}
                        transition={{ duration: 3.5, repeat: Infinity, ease: 'easeInOut' }}
                        style={{ width: 80, height: 80, borderRadius: 24, background: 'linear-gradient(135deg, rgba(125,211,252,0.2), rgba(56,189,248,0.08))', border: '1.5px solid rgba(125,211,252,0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
                    >
                        <Brain size={36} style={{ color: '#7dd3fc' }} />
                    </motion.div>

                    <div className="flex flex-col gap-5">
                        <span className="font-overline" style={{ color: '#7dd3fc', fontSize: 10, letterSpacing: '0.26em' }}>Take Control Today</span>
                    ...
                    <div className="flex items-center gap-4 flex-wrap justify-center">
                        <motion.button
                            whileHover={{ scale: 1.04, boxShadow: '0 0 60px rgba(125,211,252,0.55), 0 16px 50px rgba(0,0,0,0.5)' }}
                            whileTap={{ scale: 0.97 }}
                            onClick={() => nav('/register')}
                    ...
                    <div className="flex items-center gap-8 flex-wrap justify-center" style={{ paddingTop: 20, borderTop: '1px solid rgba(255,255,255,0.06)' }}>
                        {['100% Private', 'No payment required', 'Free Forever', 'Clinical-Grade AI'].map((item) => (
                            <div key={item} className="flex items-center gap-2">
                                <CheckCircle2 size={13} style={{ color: '#7dd3fc', opacity: 0.7 }} />
            ...
            <footer style={{ background: '#05090d', borderTop: '1px solid rgba(255,255,255,0.045)', position: 'relative', zIndex: 10 }}>
                <div className="max-w-7xl mx-auto px-6 md:px-10">
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 py-12" style={{ borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
                        <div className="flex items-center gap-3">
                            <div style={{ width: 32, height: 32, borderRadius: 9, background: 'linear-gradient(135deg, rgba(125,211,252,0.22), rgba(56,189,248,0.08))', border: '1px solid rgba(125,211,252,0.35)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                <Brain size={16} style={{ color: '#7dd3fc' }} />
                            </div>
                            <div className="flex flex-col">
                                <span className="font-display" style={{ fontSize: 14, fontWeight: 700, color: '#f0f0f0', letterSpacing: '0.04em' }}>MINDBRIDGE AI</span>
                                <span style={{ fontSize: 10, color: 'rgba(255,255,255,0.28)', letterSpacing: '0.1em', textTransform: 'uppercase' }}>Multimodal Wellness Support</span>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 py-6">
                        <span style={{ fontSize: 11, color: 'rgba(255,255,255,0.22)', letterSpacing: '0.03em' }}>
                            Â© 2025 MindBridge AI â€” Multimodal Wellness Guidance Platform
                        </span>
                        <div className="flex items-center gap-6">
                            {[
                                { label: 'Privacy Policy', message: 'MindBridge AI ensures 100% data privacy. Your session data is end-to-end encrypted and never stored permanently.' },
                                { label: 'Terms of Use', message: 'By using MindBridge AI, you agree to our terms. Please note: This is an AI support tool and not a substitute for clinical medical advice.' },
                                { label: 'Contact', message: 'Need help? Reach out to our mental health support team at hello@mindbridge.ai' }
                            ].map(item => (
                        ...
                        <p style={{ fontSize: 10, color: 'rgba(255,255,255,0.15)', textAlign: 'center' }}>
                            âš  AI support tool only â€” not a substitute for professional medical advice.
                        </p>
                    </div>
                </div>
            </footer>
                ...
                {footerModal.isOpen && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                        ...
                        <motion.div 
                            ...
                            className="bg-[#0d1720] border border-sky-500/20 rounded-2xl p-8 max-w-md w-full shadow-[0_40px_80px_rgba(0,0,0,0.6)] relative z-10 overflow-hidden"
                        >
                            ...
                            <div className="flex justify-end">
                                <button 
                                    onClick={() => setFooterModal({ ...footerModal, isOpen: false })}
                                    className="px-6 py-2.5 bg-white/5 hover:bg-sky-500/20 border border-white/10 hover:border-sky-500/50 rounded-xl text-sm font-bold text-white transition-all"
                                >
                                    Close
                                </button>
                            </div>
