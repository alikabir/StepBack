...
async def _send_message_internal(req: SendMessageRequest, user_id: int, db: Session):
    ...
    if current_message_is_risky:
        bot_reply = ("âš ï¸ I'm concerned about your safety. You are not alone. "
                     "Please reach out to a crisis helpline immediately:\n"
                     "ðŸ†˜ KIRAN: 1800-599-0019 (free, 24/7)\n"
                     "ðŸ†˜ iCALL: 9152987821\n"
    ...
    if current_stage == "problem":
        ...
        if extracted_problem and extracted_problem != "General Concern":
            ...
            if not history_list:
                next_stage_prompt = f"Hi {user_name}! ðŸ‘‹ I'm your MindBridge AI counsellor. I'm here to listen. What's been on your mind lately?"
            else:
